...
def inference_pipeline_ep(role, sess, spark_model_uri, **context):
    ...
    s3_xgboost_model = sm.list_training_jobs(MaxResults=1, StatusEquals='Completed', SortBy='CreationDate', NameContains='xgboost_training-airflow', SortOrder='Descending')['TrainingJobSummaries'][0]['TrainingJobName']
